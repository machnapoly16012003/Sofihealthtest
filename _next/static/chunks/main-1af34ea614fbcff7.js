        ...
        getMiddleware() {
          return (
            (window.__MIDDLEWARE_MATCHERS = [
              {
                regexp:
                  "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/order(.json)?[\\/#\\?]?$",
                originalSource:
                  "/:nextData(_next/data/[^/]{1,})?/order(.json)?",
              },
              {
                regexp:
                  "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/miami(.json)?[\\/#\\?]?$",
                originalSource:
                  "/:nextData(_next/data/[^/]{1,})?/miami(.json)?",
              },
              {
                regexp:
                  "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/join(.json)?[\\/#\\?]?$",
                originalSource: "/:nextData(_next/data/[^/]{1,})?/join(.json)?",
              },
            ]),
            window.__MIDDLEWARE_MATCHERS
          );
